...
const speedBar = document.querySelector('.player-speed');
...
function updateProgress() {
    ...
    displayTime((video.currentTime/video.duration) * 100);
...
speedBar.addEventListener('change', changeSpeed); 
